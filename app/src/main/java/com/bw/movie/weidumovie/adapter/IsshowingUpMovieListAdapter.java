 ...
 * 2018/11/29
 **/
public class IsshowingUpMovieListAdapter extends RecyclerView.Adapter<IsshowingUpMovieListAdapter.MyHolder>{
    private List<MovieListBean.ResultBean> list = new ArrayList<>();
    private Context context;

    public IsshowingUpMovieListAdapter(Context context) {
        this.context = context;
    }

    @NonNull
    @Override
    public IsshowingUpMovieListAdapter.MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull IsshowingUpMovieListAdapter.MyHolder myHolder, final int i) {
